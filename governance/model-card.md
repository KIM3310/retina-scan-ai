...
| Automation bias → clinician accepts a wrong AI answer | Medium | UI design mitigations; mandatory clinician review on high-confidence class; disagreement workflow |
