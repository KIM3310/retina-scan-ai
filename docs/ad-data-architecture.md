...
- Data asset: anonymous aggregate model-card topic interest and validation-template usage counts
- Sensitivity class: medical-high-trust
- Allowed events: `resource_view`, `resource_cta_click`, `architecture_doc_open`, `privacy_support_open`
- Prohibited fields: `raw_input`, `file`, `upload`, `url`, `referrer`, `title`, `user_id`, `session_id`, `ip_address`, `medical_detail`, `payment_detail`
