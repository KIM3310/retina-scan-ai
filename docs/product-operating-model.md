...
Retinal disease classification using ResNet18 transfer learning with Grad-CAM interpretability
...
| Area | Position |
| --- | --- |
| Target users | Health AI research and validation teams |
| Service wedge | Research validation template, not clinical deployment |
| System signal | Risk notes, explainability, model cards, compliance caution |
