...
The AI is never the sole gatekeeper for release. Every study passes through at least one human clinical reviewer before being closed. The AI's role is to **prioritise**, not to substitute.
