...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `openai/gpt-5.4-mini` | Non-diagnostic research summaries, dataset notes, and model-card drafting. |
...
OPENROUTER_HTTP_REFERER=https://retina-scan-ai.pages.dev
OPENROUTER_APP_TITLE=retina-scan-ai
```
