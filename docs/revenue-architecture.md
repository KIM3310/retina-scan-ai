# Revenue Architecture - retina-scan-ai
...
| Layer | Decision |
| --- | --- |
| Target buyer / user | medical AI educator, research group, or clinic innovation team needing explainable demo workflows |
| Productized offer | retinal classification research demo with Grad-CAM style explainability and compliance notes |
| First paid SKU | paid education workspace, research report pack, and private dataset evaluation support |
| Free lead magnet | free static research demo with non-diagnostic framing |
| Paid expansion | training/report package, private model evaluation, and deployment hardening consulting |
| Data / workflow moat | explainability overlays, dataset curation notes, model cards, and non-diagnostic compliance framing |
| Private inquiry | https://kim3310-doeon-kim-portfolio.pages.dev/?offer=retina-scan-ai&inquiry=industrial-validation-discovery#private-inquiry |
...
| Repo-specific launch path | GitHub Pages/Cloudflare Pages explainer, Hugging Face Spaces for CPU demo, R2/Supabase storage for sample assets, no PHI in free tier |
...
2. Route confidential and commercial requests through the [central Cloudflare D1 private inquiry](https://kim3310-doeon-kim-portfolio.pages.dev/?offer=retina-scan-ai&inquiry=industrial-validation-discovery#private-inquiry); keep public GitHub issues limited to non-confidential product discussion.
