# Service Growth Model - retina-scan-ai
...
| Field | Decision |
|---|---|
| Service type | Medical-image research validation |
| Primary reader or buyer | Research or validation teams, not clinical buyers without expert review. |
| Wedge | Research validation protocol review with medical partner input. |
