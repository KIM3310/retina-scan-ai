# Commercial Offer - Retina Scan AI
...
| Entry price assumption | $3k-$10k validation study |
...
- Send one problem-specific message, not a broad portfolio link.
- Offer a 20-minute review of the buyer's current workflow and show the matching proof artifact.
- Close on a paid diagnostic, workshop, or pilot with acceptance criteria and a written handoff.
...
- Lead with the buyer's workflow: "For Research groups, health-tech prototype teams, ML reviewers, and model governance teams, the hard part is often moving from proof to operating handoff without creating new risk."
- Use the proof hook: "I can show the first proof artifact (pytest passes), then map it to one workflow you already own."
- Use the metric hook: "The first scorecard can focus on Metric coverage, not a vague AI transformation claim."
