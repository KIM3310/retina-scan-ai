...
**This repo**: inventoried items, acceptance criteria, and review process in `risk/README.md` and `risk/fmea.md`. A formal RMP would be a separate controlled document under a QMS.
