...
This folder maps each regime to the design and operational controls that a production deployment of this service would need. It is organised so that a regulatory architecture inspection or auditor can map our evidence to their required artifacts.
